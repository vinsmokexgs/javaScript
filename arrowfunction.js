...
// const long = arr => arr.filter(str=> str.length > 5);
// console.log(long(["apple" , "Banana", "cat"]));
...
// const element = (arr , element) => arr.includes(element);
// console.log(element([1,2,3], 1));
